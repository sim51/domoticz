----------------------------------------------------------------------------------------------------------
-- Script to check the status of the `camera home mode` and update its state in Domoticz
-- 
...
-- Local viariables
----------------------------------------------------------------------------------------------------------
local deviceName = cameraName;
local script     = cameraScript .. "status";
local time       = cameraTime;
